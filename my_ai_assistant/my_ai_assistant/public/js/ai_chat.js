        ...
        div.innerHTML = `
            <div class="ai-msg-content">
                <div class="ai-msg-bubble" style="padding:8px;">
                    <div style="font-size:12px;color:#E0E7FF;margin-bottom:6px;">📸 uploaded</div>
            ...
            case 'success':
                ...
                if (response.link) {
                    ...
                    html += `<div style="margin-top:8px">
                        <a href="${response.link}" onclick="frappe.set_route('${route}');return false;" 
                    ...
                    items.forEach((item, idx) => {
                        ...
                        if (dt) {
                            ...
                            html += `<div style="padding:10px 14px;${borderStyle}font-size:13px;">
                                <a href="/app/${route}" onclick="frappe.set_route('${route}');return false;" 
